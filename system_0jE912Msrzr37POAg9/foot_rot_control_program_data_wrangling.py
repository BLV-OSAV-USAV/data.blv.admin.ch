...
print(script_dir + '/ogd/foot_rot_control_program/Cubes/canton_mapping.csv')
canton_mapping_df  = pd.read_csv('/home/runner/work/data.blv.admin.ch/data.blv.admin.ch/ogd/foot_rot_control_program/Cubes/canton_mapping.csv', sep=';')
...
# Output cleaned CSV
df_final.to_csv('/home/runner/work/data.blv.admin.ch/data.blv.admin.ch/ogd/foot_rot_control_program/Cubes/output.csv', sep=';', index=False)
